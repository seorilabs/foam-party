...
func _draw_status() -> void:
	...
	draw_string(font, Vector2(32.0, card.position.y + 32.0), "Foam Party", HORIZONTAL_ALIGNMENT_LEFT, 110.0, 20, Color("#0d3b55"))
	var coin_chip := Rect2(142.0, card.position.y + 10.0, 98.0, 28.0)
