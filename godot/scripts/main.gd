...
func _draw_status() -> void:
	...
	var coin_chip := Rect2(158.0, card.position.y + 10.0, 82.0, 28.0)
	var title_width := coin_chip.position.x - 32.0 - 8.0
	draw_string(font, Vector2(32.0, card.position.y + 32.0), "Foam Party", HORIZONTAL_ALIGNMENT_LEFT, title_width, 19, Color("#0d3b55"))
	...
	draw_string(font, Vector2(coin_chip.position.x + 30.0, coin_chip.position.y + 20.0), "%d" % coins, HORIZONTAL_ALIGNMENT_LEFT, 46.0, 14, Color("#6b5200"))
